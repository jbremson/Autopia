...
host = os.uname()[1]
print "host = " + host
SERVER="dev" # set the server name here

if host=="joel-bremsons-macbook.local":
    #sys.path.append('/Users/joelbremson/Dropbox/tmp_work/dev')
    sys.path.append(os.environ['SITE_DIR'])
    SERVER="lap"

SETUP = {}

#CACHE_BACKEND = "locmem://?timeout=30&max_entries=60"
#CACHE_BACKEND="memcached://127.0.0.1:11211/"

if SERVER=="dev":
	sys.path.append('/home/joel/dev')
    
if host=="abt":
    sys.path.append('/home/joel/dev')


if not host in ["joel-bremsons-macbook.local","abt"]:
    print "*//**** Unknown host: " + host
    print "Guessing that this is the laptop running on a wifi network. Could be wrong..."
    sys.path.append('/Users/joelbremson/Dropbox/tmp_work/dev')
    SERVER="lap"



SETUP['dev'] = {'dir':'/home/joel/dev/auto/'}
#SETUP['lap'] = { 'dir':'/Users/%s/Dropbox/tmp_work/dev/auto/' % os.environ['USER'] }
SETUP['lap'] = {'dir':"%s/auto/" % os.environ['SITE_DIR']}
DEBUG = False
TESTING = True # for Selenium

VIDEO_DIR= '/Users/joelbremson/Dropbox/tmp_work/dev/media/video'
TEMPLATE_DEBUG = DEBUG


ADMINS = (
    # ('Joel Bremson', 'joel3000@gmail.com'),
)
###### GAME SETTINGS #######
...
MANAGERS = ADMINS
DATABASES = 'django.db.backends.postgresql_psycopg2'           # 'postgresql_psycopg2', 'postgresql', 'mysql', 'sqlite3' or 'oracle'.

DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql_psycopg2',
        'NAME': "%s_db" % os.environ['INSTANCE'],
        'OPTIONS':{"autocommit": True},
        'USER':'django'
    },
}
dbs = ['game1','game2'] # autobahn games for analysis
for db in dbs:
    d= {}
    d['ENGINE']= 'django.db.backends.postgresql_psycopg2'
    d['NAME']=db
    d['OPTIONS']={"autocommit":True}
    d['USER']='django'
    DATABASES[db]=d
...
#DATABASE_NAME=SETUP[SERVER]['dir']+"app.sqlite"
HOME_DIR = SETUP[SERVER]['dir']
DATABASE_NAME="%s_db" % os.environ['INSTANCE']
#DATABASE_NAME="gsm_may_12_2"

TEMPLATE_DIRS=SETUP[SERVER]['dir']+"templates"
...
# Everything above this will stay constant through all settings files
# Everything below this is variable
# <variable section> - copy from here on out ===================================
...
#if server=="vlap":
#	TEMPLATE_DIRS = (
#		'/Users/joelbremson/.virtualenvs/a2/auto/templates',
#	)
...
COMPUTER=['mega','asian','gtech','euro','green','spec1_high','enthusiast','executive','family','young'] # vps controlled by computer
...
SAFE_TIME=50 # number of seconds that consumers must wait to buy new vehicles.
...
PHEV = {'10':0.20, '40':0.50} # The amount of electricity (as percentage of gasoline usage) a PHEVx consumes.
                                # From Kromer, Heywood 2007  - pg 61
PHEV_SCALAR = 1.4 # efficiency of electric portion of PHEV drivetrain to ICE
